...
DOCKER_DIR="/home/cozmopol/projects/church_finance/circuit_finance"
PIPELINE_DIR="$DOCKER_DIR/output"
...
docker build -t r-plotter -f src/docker/Dockerfile.r-plotter .
